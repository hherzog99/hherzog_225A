...
highlight_cluster <- function(selected_tage, selected_color){
  dittoDimPlot(Tcells, "Tage", size = 1, reduction.use = "umap", cells.use = Tcells$Tage == selected_tage, colors = selected_color, legend.show = FALSE, ylab = NULL, xlab = NULL, main = NULL, show.axes.numbers = FALSE)
}
```
